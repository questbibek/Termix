  ...
  try {
    if (file.size > CHUNK_THRESHOLD_BYTES) {
      ...
      for (let i = 0; i < totalChunks; i++) {
        ...
        // VRIT: postForm keeps the FormData multipart — plain .post() lets the
        // instance-level application/json default convert it to JSON (axios 1.x)
        // and the backend rejects the chunk. Upstream PR #1020.
